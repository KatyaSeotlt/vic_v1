        ...
        app.initSmartSelects = function (pageContainer) {
            ...
            selects.each(function () {
                ...
                if (itemAfter.length === 0) {
                    smartSelect.find('.item-inner').append('<div class="item-after"><span>' + valueText.join('</span><span>') + '</span></div>');
                }
                else {
                    ...
                    if (itemAfter.hasClass('smart-select-value')) {
                        ...
                        itemAfter.html('<span>' +valueText.join('</span><span>')+ '</span>');
                    }
                }
        ...
        app.smartSelectOpen = function (smartSelect, reLayout) {
            ...
            function handleInputs(container) {
                ...
                container.on('change', 'input[name="' + inputName + '"]', function () {
                   ...
                   var iii=optionText.join('</span><span>');
                    smartSelect.find('.item-after').html("<span>"+iii+"</span>");
        ...
        ************   Ajax submit for forms   ************
        ...
        $(document).on('submit change', 'form.ajax-submit, form.ajax-submit-onchange', function (e) {
            ...
            if(access_token!==false){
                header={Authorization:access_token, 'Accept':'application/json', 'X-Requested-With':'XMLHttpRequest'};
            }else{
            ...
            function var_name(name) {
                if (parents.length > 0) {
                    ...
                    for (var j = 0; j < parents.length; j++) {
                        ...
                        else _parents += '[' + /*encodeURIComponent(parents[j])*/ parents[j] + ']';
                    }
                    return _parents + '[' + /*encodeURIComponent(name)*/name + ']';
                }
                else {
